...
# tworzymy instancję Engine do obsługi danych
...
# __tablename__ wskazuje nazwę tabeli w bazie danych, pod którą chcemy przechowywać dane
...
# zapisanie danych w bazie i zamknięcie sesji
